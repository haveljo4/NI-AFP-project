...
pacman -S --noconfirm git wget tar man gzip zip automake make libtool patch unzip xz bison flex pkg-config &>> mintty_output.txt
pacman -S --noconfirm mingw-w64-x86_64-osslsigncode &>> mintty_output.txt
