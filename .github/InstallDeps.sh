...
echo "after -Syu" >> mintty_output.txt
yes | pacman -S wget >> mintty_output.txt
echo "after pacman wget" >> mintty_output.txt
yes | pacman -S tar >> mintty_output.txt
echo "after pacman tar" >> mintty_output.txt
yes | pacman -S unzip >> mintty_output.txt
echo "after pacman unzip" >> mintty_output.txt
yes | pacman -S zip >> mintty_output.txt
echo "after pacman zip" >> mintty_output.txt
yes | pacman -S man >> mintty_output.txt
echo "after pacman man" >> mintty_output.txt
