...
spec = do
  describe "ChessComJsonHelper tests" $ do
    ...
    it "filterArchives" $ do
      JsonHelper.filterArchives 2015 1 2016 6 jsonString  `shouldBe` Right (validUrls, invalidUrls )
        where
          jsonString :: String 
          jsonString =     "{ \"archives\": ["
                           ...
                           ++ "\"mn *& 93 *+/games/2017/13\""
                           ++ "]}"
          validUrls = ["https://api.chess.com/pub/player/somePlayerName/games/2015/05",
                           "https://api.chess.com/pub/player/somePlayerName/games/2015/06"]
          invalidUrls = ["https://api.chess.com/pub/player/somePlayerName/games/2009/04",
                        "https://api.chess.com/pub/player/somePlayerName/games/2023/06",
                        "mn *& 93 *+/games/2017/13"]
